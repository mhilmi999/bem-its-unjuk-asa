      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-xxl-6">
          <div class="text-center my-5">
            <h1 class="warnapaletungu display-5 fw-bolder mb-2 ">Kementerian Ekonomi Kreatif</h1>
          </div>
        </div>
      </div>

      <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="<?= base_url(); ?>assets/img/akarinov/ekraf/ekraf.png" alt="Foto Kegiatan Kementerian Ristek BEM ITS" /></div>
      <div class="col-lg-8 col-xl-7 col-xxl-6">
        <p class="lead fw-normal warnapaletungu mb-4">Kementerian Ekonomi Kreatif berperan untuk membantu mewujudkan BEM ITS mandiri finansial dan memfasilitasi ekosistem kewirausahaan di ITS sekaligus pusat informasi kewirausahaan bagi seluruh KM ITS.</p>
      ...
      <div class="accordion" id="accordionPanelsStayOpenExample">
        <div class="accordion-item rounded-3">
          <h2 class="accordion-header" id="panelsStayOpen-headingOne">
            ...
            Pengembangan Karya Kewirausahaan
            </button>
          </h2>
          <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
            <div class="accordion-body">
            Kegiatan pengembangan ekosistem kewirausahaan ITS melalui pendampingan terhadap mahasiswa ITS dan kerjasama dengan mitra eksternal.
            </div>
          </div>
        </div>
        <br>
        <div class="accordion-item rounded-3">
          ...
          <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
            <div class="accordion-body">
            Kegiatan branding kemetrian dan pengenalan karya kewirausahaan mahasiswa ITS melalui platform digital kepada internal dan eksternal ITS.
            </div>
          </div>
        </div>
        <br>
        <div class="accordion-item rounded-3">
          ...
          <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
            <div class="accordion-body">
            Penghimpunan data usaha yang dimilki oleh seluruh mahasiswa ITS.
            </div>
          </div>
        </div>
        <br>
        <div class="accordion-item rounded-3">
          ...
          <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFour">
            <div class="accordion-body">
            Kegiatan yang dilakukan untuk menunjang keuangan BEM-ITS.
            </div>
          </div>
        </div>
        <br>
        <div class="accordion-item rounded-3">
          ...
          <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFive">
            <div class="accordion-body">
            Forum diskusi  antar stakeholder kewirausahaan di ITS untuk membahas kesepakatan ranah ranah kerja dalam bidang kewirausahaan di ITS.	
            </div>
          </div>
        </div>
        <br>
        <div class="accordion-item rounded-3">
          <h2 class="accordion-header" id="panelsStayOpen-headingSix">
            ...
            Economic Inspiring Seminar
            </button>
          </h2>
          <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSix">
            <div class="accordion-body">
            Webinar tentang kewirausahaan yang berskala institut dan nasional dengan target internal ITS dan umum.
            </div>
          </div>
        </div>
        <br>
        <div class="accordion-item rounded-3">
          ...
          <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSeven">
            <div class="accordion-body">
            Pelatihan di bidang kewirausahaan tingkat dasar dan lanjut untuk seluruh mahasiswa ITS.
            </div>
          </div>
        </div>
      </div>
