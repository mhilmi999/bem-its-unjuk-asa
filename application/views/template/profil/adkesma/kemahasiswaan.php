<!-- Deskripsi Kemenkoan-->
<header class="slidekemenbg py-5">
    <div class="container px-5">
        <div class="row gx-5 align-items-center justify-content-center">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-xxl-6">
                    <div class="text-center">
                        <h2 class="fontnavbar  fw-bolder ">Kementerian Koordinasi Kemahasiswaan</h2>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-md-3 mb-3 mx-5 rounded-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        <!-- Linkedin -->
                                                        <a class="btn btn-link btn-floating btn-lg" href="http://linkedin.com/in/nadia-azhaar-3368451b4" target="_blank" role="button" data-mdb-ripple-color="dark"><i style="color: #fffff;" class="fab fa-linkedin"></i></a>
                                                        <!-- Instagram -->
                                                        <a class="btn btn-link btn-floating btn-lg" href="instagram.com/nadiazhaar" target="_blank" role="button" data-mdb-ripple-color="dark"><i style="color: #fffff;" class="fab fa-instagram"></i></a>
                                                    </div>
...
<!-- Kementerian naungan -->
<div class="container-fluid pt-5 bgpkagendaunjukasa">
